    ...
    return (
        <main className="w-full h-[50vh]  md: h-[78vh] bg-cover bg-center text-center flex justify-center items-center px-4">
            <div className="flex flex-col justify-center items-center">
                ...
                <button className="w-[80%] lg:mt-[3%]   md:w-[45%] mt-[10.5%] text-center font-semibold border-2 cursor-pointer rounded-2xl text-[#fff] border-[#fff] p-2  hover:bg-[#fff] ease-in-out duration-500 hover:text-[#f03636]">
                    AGENDAR
                </button>
            </div>
        </main>
